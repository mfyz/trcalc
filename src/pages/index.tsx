        ...
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div className="max-w-md mx-auto px-2 py-1.5 flex items-center justify-between">
            <div className="relative">
              <Link
                href="/settings"
                className="text-gray-600 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200 p-1.5 block"
              >
                <svg
            ...
            {isLoaded && (
              ...
              >
                <svg
                  id="auto-reset-icon"
                  xmlns="http://www.w3.org/2000/svg"
                  className={`h-5 w-5 transition-opacity ${settings.autoReset ? 'text-gray-600 dark:text-gray-400' : 'text-gray-400 opacity-40'}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={2}
